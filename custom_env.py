...
from cards_config import int_to_jcards, jcards_to_int, ranks
from cards_config import Suit, Card
...
class BlackjackEnv(gym.Env):
    ...
    def render(self, mode='human', close=False):
        ...
        for card in self.player_hand:
            ...
            hand_list_input.append(jcards_to_int[card.name()])
        ...
        print(f'Player Hand Input: {hand_list_input}')
